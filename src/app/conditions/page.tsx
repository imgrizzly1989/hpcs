  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="prose mt-6 max-w-none text-neutral-700 space-y-3">
        <p>Les présentes conditions régissent les ventes effectuées via le site CHINAPAL.</p>
        ...
        <p>CHINAPAL garantit la conformité des pièces. La responsabilité de CHINAPAL ne peut être engagée pour des dommages liés à une installation incorrecte.</p>
