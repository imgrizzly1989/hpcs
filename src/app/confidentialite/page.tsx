  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="prose mt-6 max-w-none text-neutral-700 space-y-3">
        <p>HPCS respecte la vie privée de ses clients conformément à la loi 09-08 relative à la protection des données personnelles au Maroc.</p>
        ...
        <p>Vous pouvez à tout moment demander l&apos;accès, la rectification ou la suppression de vos données en écrivant à contact@hpcs.ma.</p>
      </div>
    </div>
  );
}
